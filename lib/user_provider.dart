...
class UserProvider with ChangeNotifier {
  ...
  void _loadUsers() async {
    if (_eventId == 0) {
      ...
      // Fetch users filtered by eventId
      _users = await db.query(
        'users',
        where: 'eventId = ?', // Apply condition
        whereArgs: [_eventId], // Pass eventId as argument
      );
    }
    notifyListeners();
  }
  ...
  Future<void> addUser(String name, int eventId,String mobile, bool isFavorite, String tags, String comments) async {
  ...
  Future<void> updateUser(int id,String name, int eventId, String mobile, bool isFavorite, String tags, String comments,String lastCalled) async {
  ...
  Future<void> _loadTags() async {
    final prefs = await SharedPreferences.getInstance();
    _predefinedTags = prefs.getStringList('tags') ?? ['Tag1', 'Tag2'];
    notifyListeners();
  }
